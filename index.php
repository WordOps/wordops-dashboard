...
<head>
  ...
  <style>.svg-inline--fa { padding-right: 0.3em; font-size: 1.5em; }</style>
</head>
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html">WordOps Dashboard</a>
            ...
            <div class="col-xl col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                         <span class="h2 font-weight-bold mb-0"><div data-netdata="system.cpu" data-title="CPU Usage" data-chart-library="gauge" data-height="320" data-width="100%" data-points="60"
                          data-after="-60"></div></span>
                   </div>
            ...
            <div class="col-xl col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                          <span class="h2 font-weight-bold mb-0"><div class="netdata-container-gauge" data-netdata="nginx_local.connections" data-dimensions="" data-height="270" data-width="100%"
                          data-chart-library="gauge" data-gauge-adjust="width" data-title="Nginx Connections" data-before="0" data-after="-480"
                          data-points="CHART_DURATION" data-colors="#0099C6" role="application"></div></span>
                    </div>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><div class="netdata-container-gauge" data-netdata="nginx_local.requests" data-dimensions="" data-height="270" data-width="100%"
                        data-chart-library="gauge" data-gauge-adjust="width" data-title="Nginx Requests" data-before="0" data-after="-480"
                        data-points="CHART_DURATION" data-colors="#66AA00" role="application" style="will-change: transform;"></div></span>
                    </div>
            ...
            <div class="col-xl col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <span class="h2 font-weight-bold mb-0"><div class="netdata-container-gauge" data-netdata="net.eth0" data-dimensions="received" data-height="270" data-width="100%"
                       ...
                       data-colors="" role="application" style="width: 12%; will-change: transform;"></div></span>
                    </div>
            ...
            <div class="col-xl col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <span class="h2 font-weight-bold mb-0"><div class="netdata-container-gauge" data-netdata="net.eth0" data-dimensions="sent" data-height="270" data-width="100%" data-chart-library="gauge"
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="https://<?php echo $root;?>/netdata/" class="btn btn-sm btn-primary" target="_blank">See all</a>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div>
                          <embed src="https://<?php echo $root; ?>/netdata/api/v1/badge.svg?chart=system.load&alarm=load_average_15&refresh=auto" type="image/svg+xml" height="20"/>
                        </div>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        ...
                        <div>
                          <embed src="https://<?php echo $root; ?>/netdata/api/v1/badge.svg?chart=mem.available&alarm=ram_available&refresh=auto" type="image/svg+xml" height="20"/>
                        </div>
                      </div>
                    </td>
                  </tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <div>
                            ...
                            <embed src="https://<?php echo $root; ?>/netdata/api/v1/badge.svg?chart=system.entropy&alarm=lowest_entropy&refresh=auto" type="image/svg+xml" height="20"/>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2018 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Creative Tim</a> modified by <a href="https://virtubox.net" class="font-weight-bold" target="_blank">VirtuBox</a>
            </div>
          </div>
          <div class="col-xl-6">
